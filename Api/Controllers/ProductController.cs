...
public class ProductController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAllProductsByShopId(long shopId, int pageNumber, int pageSize)
    {
    ...
    public async Task<IActionResult> GetAllProductsByCategoryIds(List<int> categoryIds)
    {
